...
void mostrarAlquilados(vecAuto a,int b){
		...
		if(a[i].estado==true){
			cout<<"Patente: "<<a[i].patente<<" ESTADO: ALQUILADO."<<endl;
		}
	}
...
void procesarAlquileres(vecAuto a, int b){
	...
	strcpy(operacion,"");
	strcpy(respuesta,"");
linea67:	cout<<"que operacion desea realiazar? (A para alquilar D para devolucion); "<<endl;
	cin>>operacion;
	...
	if (strcmp(respuesta,"S")==0){
		...
		cout<<"fin de procesar alquileres."<<endl;
	}
