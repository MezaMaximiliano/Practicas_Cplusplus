...
void buscar(vector persona,int &nFinal,int &respuesta){
	...
	if (((strcmp(nombreBusqueda,"fin"))!=0)){
		...
		if (i<=nFinal-1){ // cout<<persona[posicion].nombre<<" nacio "<<persona[posicion].anio<<endl;
			
			 if (posicion<1){
				cout<<"posicion "<<posicion<<endl;
				cout<<"nFinal "<<nFinal<<endl;
				cout<<"Nombre buscado: "<<persona[posicion].nombre<<" y nacio "<<persona[posicion].anio<<endl;
				cout<<"No hay una posicion anterior"<<endl;
				cout<<"Posicion siguiente: "<<persona[posicion+1].nombre<<" y nacio "<<persona[posicion+1].anio<<endl;	
				
			}else if (posicion==nFinal-1){
				cout<<"posicion "<<posicion<<endl;
				cout<<"nFinal "<<nFinal<<endl;
				cout<<"Nombre buscado: "<<persona[posicion].nombre<<" y nacio "<<persona[posicion].anio<<endl;
				cout<<"Posicion anterior: "<<persona[posicion-1].nombre<<" y nacio "<<persona[posicion-1].anio<<endl;
				cout<<"No hay Posicion siguiente: "<<endl;	
			}else if ( (posicion>=1)and(posicion<nFinal-1) ){
				cout<<"posicion "<<posicion<<endl;
				cout<<"nFinal "<<nFinal<<endl;
				cout<<"Nombre buscado: "<<persona[posicion].nombre<<" y nacio "<<persona[posicion].anio<<endl;
				cout<<"Posicion anterior: "<<persona[posicion-1].nombre<<" y nacio "<<persona[posicion-1].anio<<endl;
