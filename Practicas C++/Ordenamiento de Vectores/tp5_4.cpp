...
void difFecha(vector persona,int &tope){
	int i=0,anio1=0,mes1=0;
	for (i;i<=tope;i++){
		anio1=(f.a-persona[i].anio)*12*30;
		mes1=(f.m - persona[i].mes)*30;
		persona[i].difFecha=anio1+mes1+(f.d-persona[i].dia);
	}
